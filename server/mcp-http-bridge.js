...
const TOOLS = {
  ...
  get_whaiblog_config: {
    description: 'Get WhaiBlog client configuration',
    parameters: { type: 'object', properties: {} }
  },
  set_whaiblog_config: {
    description: 'Set WhaiBlog client configuration',
    parameters: {
      type: 'object',
      properties: {
  ...
  list_feeds: {
    ...
    parameters: { type: "object", properties: { page: { type: "number" }, limit: { type: "number" }, source: { type: "string", description: "Filter by source name, or '__local__' for manually created feeds with no source" } } }
  },
  get_feed: {
  ...
  add_rss_source: {
    ...
    parameters: { type: "object", properties: { url: { type: "string", description: "RSS feed URL" }, title: { type: "string", description: "Display name" } }, required: ["url"] }
  },
  list_rss_sources: {
  ...
  fetch_rss: {
    ...
    parameters: { type: "object", properties: { id: { type: "number", description: "Source ID (omit to fetch all)" } } }
  },
  get_rss_status: {
